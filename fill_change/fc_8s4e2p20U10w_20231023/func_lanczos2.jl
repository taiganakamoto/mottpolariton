...
function lanczos(hamil, steps)
    ...
    dum = zeros(Float64,Ndim)
    v1 = rand(Float64,Ndim)
    v2 = zeros(Float64,Ndim)
    w1 = zeros(Float64,Ndim)
    w2 = zeros(Float64,Ndim)
